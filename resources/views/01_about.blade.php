...
<html lang="en">
    ...
    <body>
        ...
        <nav class="nav-bar nav-bar-home-3 fixed-top">
            <div class="container">
                <div class="box-content d-flex align-items-center justify-content-between">
                    <div class="logo">
                        <h4 class="navbar-brand"><i class="fa-solid fa-street-view"></i>  <strong>moSafir</strong></h4>
        ...
        <!-- :: Breadcrumb Header -->
        <section class="breadcrumb-header" id="page" style="background-image: url(images/header/02_header.jpg)">
                    ...
                    <div class="col-lg-6">
                        <div class="row img-box">
                            <div class="col">
                                <div class="one">
                                    <div class="about-img">
                                        <img class="img-fluid" src="images/about/01_about.jpg" alt="01 About">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="two">
                                    <div class="about-img">
                                        <img class="img-fluid" src="images/about/02_about.jpg" alt="02 About">
                ...
                <div class="sec-title">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 d-flex align-items-center justify-content-end button-sec">
                            <a href="01_services.html" class="btn-1 btn-3">All Services</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="services-item">
                            ...
                            <a href="01_services.html" class="more">read more</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="services-item">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="text-box">
                            <div class="sec-title">
                                <h3>Petrol provide the best service for sustainable progress</h3>
                                <p>Petrol Are A Professional Industry and Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry and any Industrial related business field.</p>
                            </div>
                            <div class="row">
            ...
            <div class="container">
                <div class="sec-title">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 d-flex align-items-center justify-content-end button-sec">
                            <a href="01_team.html" class="btn-1 btn-3">All Team</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="team-box">
                            <div class="img-box">
                                <img class="img-fluid" src="images/team/01_team.jpg" alt="01 team">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team-box">
                            <div class="img-box">
                                <img class="img-fluid" src="images/team/02_team.jpg" alt="02 team">
                                <div class="img-box-hover">
                                    <ul>
                                        <li><i class="fab fa-facebook-f"></i></li>
                                        <li><i class="fab fa-twitter"></i></li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team-box">
                            <div class="img-box">
                                <img class="img-fluid" src="images/team/03_team.jpg" alt="03 team">
                                <div class="img-box-hover">
                                    <ul>
                                        <li><i class="fab fa-facebook-f"></i></li>
                                        <li><i class="fab fa-twitter"></i></li>
            ...
            <div class="container">
                <div class="sec-title">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 d-flex align-items-center justify-content-end button-sec">
                            <a href="02_blog.html" class="btn-1 btn-3">All Blogs</a>
                        </div>
                    </div>
                </div>
                <div class="row">
