                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="item-careers">
                            <h4><a>Financial &amp; Administrative Accountant - 01</a></h4>
                            <ul>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item-careers">
                            <h4><a>General Manager Of Financial Management - 02</a></h4>
                            <ul>
                                <li class="active">Full Time</li>
                                <li>New York</li>
                            </ul>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item-careers">
                            <h4><a>Director Of Sales - 03</a></h4>
                            <ul>
                                <li class="active">Full Time</li>
                                <li>New York</li>
                            </ul>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item-careers">
                            <h4><a>Director Of Production Department - 04</a></h4>
                            <ul>
                                <li class="active">Full Time</li>
                                <li>New York</li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="sec-title text-center">
                            ...
                            <a class="btn-1" href="01_contact.html">Request A Quote</a>
                        </div>
                    </div>
                </div>
            </div>
