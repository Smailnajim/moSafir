                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="sec-title">
                            ...
                            <p>Petrol Are A Professional Industry and Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry and any Industrial related business field.</p>
                            <a href="01_single-services.html" class="btn-1">Download our brochure</a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="quote-info d-flex align-items-start flex-column">
                                    <div class="info-top mb-auto">
                                        ...
                                        <div class="item">
                                            <h5>Quick Contact</h5>
                                            <p>Petrol@AR-Coder.com,<br>AR-Coder@Petrol.com</p>
                                        </div>
                                    </div>
                                    <div class="info-down">
                            ...
                            <div class="col-lg-8">
                                <div class="text-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quote-item">
                                                <select>
                                                    ...
                                                    <option value="2">Petroleum &amp; Gas Energy</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="quote-item">
                                                <a class="btn-1 btn-3">Send Message</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="sponsors-box owl-carousel owl-theme">
                    <div class="sponsors-box-item">
                        <img class="img-fluid" src="images/sponsors/01_sponsors.png" alt="01 Sponsors">
                    </div>
                    <div class="sponsors-box-item">
                        <img class="img-fluid" src="images/sponsors/02_sponsors.png" alt="02 Sponsors">
                    </div>
                    <div class="sponsors-box-item">
                        <img class="img-fluid" src="images/sponsors/03_sponsors.png" alt="03 Sponsors">
                    </div>
                    <div class="sponsors-box-item">
                        <img class="img-fluid" src="images/sponsors/04_sponsors.png" alt="04 Sponsors">
                    </div>
                </div>
            </div>
        </div>
